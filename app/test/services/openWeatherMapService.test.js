...
describe('OpenWeatherMapService', function () {
    describe('getCurrentWeatherByLocation', function (){
        it('should return the correct array', function () {
            return new OpenWeatherMapService(config.credentialsConfig.openWeather).getCurrentWeatherByLocation(37.227029, -80.421044)
            .then(res => {
    ...
    describe('GetForecastWeatherData', function (){
        it('should return the correct array', function () {
            return new OpenWeatherMapService(config.credentialsConfig.openWeather).GetForecastWeatherData(37.227029, -80.421044)
            .then(res => {
