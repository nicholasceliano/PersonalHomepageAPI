...
describe("GoogleOAuthService", function() {
    describe("checkGapiAuth", function() {
        it("returns an error because no oAuth Token", function(done) {
            // TODO: cant test checkGapiAuth from GoogleOAuthService because no req/res mock library
            //https://stackoverflow.com/questions/14487809/how-to-mock-request-and-response-in-nodejs
            //-to-test-middleware-controllers
